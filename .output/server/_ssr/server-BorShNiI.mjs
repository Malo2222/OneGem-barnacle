...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/server-BorShNiI.js
var server_BorShNiI_exports = /* @__PURE__ */ __exportAll({
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B_BCprML.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-86PnajQz.mjs").then((n) => n.t),
		import("./start-CxDZ5zFl.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, createCsrfMiddleware as n, createMiddleware as r, server_BorShNiI_exports as t };
